...
from keras.callbacks import LearningRateScheduler #keras.callbacks.LearningRateScheduler(schedule, verbose=0)
...
# load the training and testing data, then scale it it into the range [0, 1]
