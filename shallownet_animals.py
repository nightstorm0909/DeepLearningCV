...
# grab the list the images that we'll be describing
...
model.compile(loss = 'categorical_crossentropy', optimizer = opt, metrics = ['accuracy']) # Configures the model for training
