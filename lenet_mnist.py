...
# if we are using 'channel first' ordering, then reshape the design matrix such that the
# matrix is:
...
# scale the imput data to the range [0, 1] and perform a train / test split
