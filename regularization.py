...
# partition the data into training and testing splits using 75% of the data for training and
...
for r in (None, 'l1', 'l2'):
	# train a SGD classifier using a softmax loss function and the specified regulariation function
	# for 10 epochs
